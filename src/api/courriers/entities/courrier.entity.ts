...
const CotationEmployeSchema = SchemaFactory.createForClass(CotationEmploye);
...
export class Cotation {
    ...
    @Prop({type: [CotationEmployeSchema], default: []})
    cotation_employe: CotationEmploye[];
